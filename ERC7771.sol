...
contract ERC777Inherit is ERC777 {
    ...
    constructor(string memory name,string memory symbol, uint256 initialSupply, address[] memory defaultReferrerAddress) 
    ERC777(name, symbol, defaultReferrerAddress) {
           owner = msg.sender;
        
        _mint(owner, initialSupply, "", "");
    }
//   function stakingReffer(uint256 amount, address referrer) external {
...
//     require(user.referrer1 == address(0), "referrer bonded");
//     user.referrer1 = _referral;
//     userInfo[user.referrer1].directsNum = userInfo[user.referrer1].directsNum.add(1);
